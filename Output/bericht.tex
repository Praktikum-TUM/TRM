...
beiden Haltungen, wieder mit der Lichtschranke der kleinen
Drehachse.
...
ausgestreckten Haltung zusätzlich von der Streuung der beiden
...
noch etwas stärker, da sie die seitlichen Gliedmaßen nicht
berücksichtigt.
...
überein, die kleine Drehachse ist also gut kalibriert. Die
...
Die geometrischen Verhältnisse sind also doch nicht so ähnlich. Literaturwerte für das Trägheitsmoment des Menschen
...
\begin{itemize}
  ...
  \item Modellrechnung (Zylinder + Kugel + Steiner) liefert für
        ...
        in guter Übereinstimmung mit der Messung. In der
